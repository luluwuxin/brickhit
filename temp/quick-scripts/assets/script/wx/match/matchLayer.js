(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/wx/match/matchLayer.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e51adBctDtB1q1m6Rs8cyrA', 'matchLayer', __filename);
// script/wx/match/matchLayer.js
...
cc.Class({
    ...
    onShare: function onShare() {
        wx.shareAppMessage({
            ...
            // },
            query: 'matchId=' + self.matchData._id + '&starttime=' + self.matchData.starttime + '&endtime=' + self.matchData.endtime + '&limitscore=' + self.matchData.limitscore,
    ...
    updateMarqueeItem: function updateMarqueeItem(item) {
    ...
    createMarqueeItem: function createMarqueeItem() {
