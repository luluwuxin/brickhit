(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/wx/rank/friendLayer.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '9a18cIg/KZK9q8PI8UBLfAI', 'friendLayer', __filename);
// script/wx/rank/friendLayer.js
...
cc.Class({
    ...
    initRank: function initRank(isGroup, callbacks) {
    ...
    getFriendsNextBtn: function getFriendsNextBtn() {
    ...
    getFriendsBeforeBtn: function getFriendsBeforeBtn() {
        var openDataContext = wx.getOpenDataContext();
        openDataContext.postMessage({
    ...
    getFriendsCloseBtn: function getFriendsCloseBtn() {
        var openDataContext = wx.getOpenDataContext();
        openDataContext.postMessage({
            id: MSG.MessageID.ON_MSG_GET_FRIEND_RANK_CLOSE
        });
    },
    showSharedCanvas: function showSharedCanvas() {
        if (!self.todraw) {
    ...
    _showFriendsRankImg: function _showFriendsRankImg() {
        self.todraw = true;
        self.unschedule(self.showSharedCanvas);
...
cc._RF.pop();
        ...
        //# sourceMappingURL=friendLayer.js.map
