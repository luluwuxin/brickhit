(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/wx/rank/rankLayer.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '29576r6q6hDhK5FZd6Z3jwr', 'rankLayer', __filename);
// script/wx/rank/rankLayer.js
...
cc.Class({
    ...
    //终止 touch 传递
    maskTouch: function maskTouch(event, cusData) {
        if (event) {
            event.stopPropagation();
        }
    },
    qunRankBtn: function qunRankBtn() {
    ...
    createItem: function createItem(i, info) {
        var _item = cc.instantiate(self.listItem);
        var itemJs = _item.getComponent('item');
        itemJs.init(info, i);
        return _item;
    },
    init: function init(res, callbacks, isWeek) {
    ...
    initBestsData: function initBestsData() {
    ...
    _initBestsView: function _initBestsView(list) {
        for (var i = 0; i < 3; i++) {
            var value = list[i];
            if (typeof value != "undefined") {
    ...
    _initBest: function _initBest(index, value) {
    ...
    _initLoopScrollView1: function _initLoopScrollView1(_scroll, num, data) {
    ...
    _resetLoopScrollView: function _resetLoopScrollView(_scroll, num) {
        //_scroll.moveToFront(0.1);
        _scroll.setTotalNum(num);
        _scroll.resetView();
    },
    _initLoopScrollView2: function _initLoopScrollView2(_scroll, num, data) {
    ...
    //     }
    // },
    checkTongle1: function checkTongle1() {
        console.log("check1");
    ...
    checkTongle2: function checkTongle2() {
        console.log("check2");
